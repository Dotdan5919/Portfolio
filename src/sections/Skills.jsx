...
<div className="left-skills sm:left-auto left-10 flex flex-col gap-10 absolute z-[2] sm:w-[700px]  lg:w-[900px] lg:right-auto  ">
...
<div className="right-skills right-10 sm:right-auto flex flex-col gap-10 absolute  sm:w-[700px]  z-[0] sm:left-auto  items-end lg:w-[900px] left-[200px]  ">
